...
class PremiumProgressBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ClipRRect(
      ...
      child: LinearProgressIndicator(minHeight: 10, value: safeValue, backgroundColor: Colors.white.withValues(alpha: 0.08), valueColor: AlwaysStoppedAnimation<Color>(color)),
    );
  }
}
