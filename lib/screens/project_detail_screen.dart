          ...
          child: Center(
            child: ConstrainedBox(
              ...
              child: CustomScrollView(
                slivers: [
                  SliverAppBar(pinned: true, backgroundColor: AppTheme.background.withValues(alpha: 0.78), title: Text(_project.name, style: const TextStyle(fontWeight: FontWeight.w900))),
                  SliverPadding(
